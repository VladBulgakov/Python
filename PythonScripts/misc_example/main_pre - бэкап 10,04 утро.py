...
class MainApp(tk.Tk):
    ...
    def initUI(self):
        ...
        sorting_dropdown.grid(row=1, column=0, sticky=tk.EW)
        # Кнопка сортировки
        ...
        outer_data_frame.grid(row=2, column=0, columnspan=4, sticky=tk.EW)
